...
namespace Obi
{
    ...
    public class ObiSoftbodySurfaceBlueprint : ObiSoftbodyBlueprintBase
    {
        ...
        protected override IEnumerator Initialize()
        {
            ...
            filters = new int[particles.Count];
            ...
            for (int i = 0; i < particles.Count; ++i)
            {
                ...
                filters[i] = ObiUtils.MakeFilter(ObiUtils.CollideWithEverything, 1);//ObiUtils.MakePhase(1, oneSided ? ObiUtils.ParticleFlags.OneSided : 0); 
