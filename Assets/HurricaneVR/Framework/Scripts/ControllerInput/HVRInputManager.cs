...
//            }
        ...
        private XRInputSystem GetController(string manufacturer, string controllerName)
        {
            ...
            var isWindowsMixedReality = manufacturer.Contains(WindowsMR) || controllerName.Contains(WMRController);
            ...
            {
                if (controllerName.Contains(ReverbG2.ToLower()))
        ...
        private bool IsKnuckles(string manufacturer, string controllerName)
        {
            if (controllerName.Contains(Knuckles))
                return true;
            if (controllerName.Contains("index controller")) //openxr
                return true;
            return false;
        }
